...
from harness_context.interfaces.mcp.capabilities import SERVER_NAME
from harness_context.interfaces.mcp.middleware import RequestMiddleware
from harness_context.interfaces.mcp.tools import register_tools
...
def create_mcp_server(container, default_workspace_id: str, lifecycle=None,
    ...
    events = events or container.events
    metrics = metrics or container.metrics
