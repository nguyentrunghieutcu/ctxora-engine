...
1. Call `route_skills` to rank a small relevant set; `prepare_context` also routes automatically in `diagnostics.skills`.
...
5. Submit skill feedback and save durable memory only after verification.
