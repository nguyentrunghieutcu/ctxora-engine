...
class UpdateServiceTests(unittest.TestCase):
    ...
    def test_release_version_and_update_cli_contract(self):
        self.assertEqual("6.5.2", __version__)
    ...
    def test_all_release_version_markers_are_synchronized(self):
        ...
        self.assertEqual("6.5.2", lock["version"])
        self.assertRegex(pyproject, re.compile(r'^version = "6\.5\.2"$', re.MULTILINE))
        self.assertIn('const PACKAGE_VERSION = "6.5.2"', launcher)
